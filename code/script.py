...
result = result.replace('</defs>','</defs><image xlink:href="https://raw.githubusercontent.com/kritserv/githubstat-display-card/main/code/img/bg_image.png?sanitize=true" height="500" x="0" y="0" />')
# add foreground image
result = result.replace('</rect><text','</rect><image xlink:href="https://raw.githubusercontent.com/kritserv/githubstat-display-card/main/code/img/fg_image.png?sanitize=true" height="330" x="40" y="20" /><text')
