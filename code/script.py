...
result = result.replace('</defs>','</defs><image href="https://raw.githubusercontent.com/kritserv/githubstat-display-card/main/code/img/bg_image.png" height="500" x="0" y="0"/>')
# add foreground image
result = result.replace('</rect><text','</rect><image href="https://raw.githubusercontent.com/kritserv/githubstat-display-card/main/code/img/fg_image.png" height="330" x="40" y="20"/><text')
