...
result = result.replace('</defs>','</defs><image href="code/img/bg_image.jpg" height="500" x="0" y="0"/>')
# add foreground image
result = result.replace('</rect><text','</rect><image href="code/img/fg_image.jpg" height="330" x="40" y="20"/><text')
